...
question_topic_tagging6  = QuestionTopicTagging.create!({topic_id: topic4.id, question_id: question6.id})
question_topic_tagging7  = QuestionTopicTagging.create!({topic_id: topic3.id, question_id: question3.id})
question_topic_tagging8  = QuestionTopicTagging.create!({topic_id: topic1.id, question_id: question2.id})
question_topic_tagging9  = QuestionTopicTagging.create!({topic_id: topic2.id, question_id: question7.id})
question_topic_tagging10 = QuestionTopicTagging.create!({topic_id: topic1.id, question_id: question6.id})
question_topic_tagging11 = QuestionTopicTagging.create!({topic_id: topic2.id, question_id: question1.id})
question_topic_tagging12 = QuestionTopicTagging.create!({topic_id: topic1.id, question_id: question8.id})
