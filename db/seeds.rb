...
topic6 = Topic.create!({name:'Engineering'})
...
question12 = Question.create!({title: 'How do you choose where to work?', body: '', author_id: guest3.id, topic_id: topic6.id})
...
comment16 = Comment.create!({body: 'Frankly speaking, I do not know the answer to this question', answer_id: answer3.id, author_id: guest7.id})
